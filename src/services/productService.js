...
const blueprint = {
  laptop: {
    ...
    brand: 'AeroTech',
    image: `${baseUrl}images/products/laptop.webp`,
    price: 1299,
    rating: 4.8,
    stock: 12
  },
  ...
  headphones: {
    ...
    brand: 'Pulse Audio',
    image: `${baseUrl}images/products/headphones.webp`,
    price: 189,
    rating: 4.7,
    stock: 18
  },
  ...
  smartphone: {
    ...
    brand: 'Nova Mobile',
    image: `${baseUrl}images/products/smartphone.webp`,
    price: 799,
    rating: 4.6,
    stock: 15
  },
  ...
  smartwatch: {
    ...
    brand: 'Motion Lab',
    image: `${baseUrl}images/products/smartwatch.webp`,
    price: 229,
    rating: 4.5,
    stock: 11
  },
  ...
  keyboard: {
    ...
    brand: 'Core Gear',
    image: `${baseUrl}images/products/keyboard.webp`,
    price: 129,
    rating: 4.8,
    stock: 9
  },
  ...
  mouse: {
    ...
    brand: 'Flow Devices',
    image: `${baseUrl}images/products/mouse.webp`,
    price: 79,
    rating: 4.6,
    stock: 24
  },
  ...
  tablet: {
    ...
    brand: 'Vision Tech',
    image: `${baseUrl}images/products/tablet.webp`,
    price: 569,
    rating: 4.7,
    stock: 14
  },
  ...
  webcam: {
    ...
    brand: 'Vision Tech',
    image: `${baseUrl}images/products/webcam.webp`,
    price: 109,
    rating: 4.5,
    stock: 17
  }
...
function normalizeApiProduct(key, source) {
  ...
  return {
    ...
    price: Number.isFinite(Number(source.price))
      ? Number(source.price)
      : base.price,
    rating: Number.isFinite(Number(source.rating))
      ? Number(source.rating)
      : base.rating,
    stock: Number.isFinite(Number(source.stock))
      ? Number(source.stock)
      : base.stock,
...
export async function fetchProducts() {
  try {
    ...
    const laptops =
      laptopResult.status === 'fulfilled'
        ? laptopResult.value
        : []

    const smartphones =
      smartphoneResult.status === 'fulfilled'
        ? smartphoneResult.value
        : []

    const tablets =
      tabletResult.status === 'fulfilled'
        ? tabletResult.value
        : []
    ...
    const audio =
      accessories.find((item) =>
        /airpods max|headphone/i.test(item.title || '')
      ) ||
      accessories.find((item) =>
        /airpod|earphone|earbud|buds|audio/i.test(item.title || '')
      )

    const watch =
      accessories.find((item) =>
        /watch/i.test(item.title || '')
      )
    ...
    return {
      ...
      source: 'fallback',
      warning:
        'No fue posible conectar con la API. Se cargó el catálogo local de respaldo para mantener la aplicación operativa.',
      originalError:
