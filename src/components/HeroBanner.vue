  ...
  <section class="hero page-shell" aria-labelledby="hero-title">
    <div class="hero-panel">
      <div class="hero-copy">
        ...
        <p>
          Explora un catálogo interactivo, compara categorías y guarda tus
          favoritos en una SPA moderna construida con Vue.
        </p>
        ...
        <div class="tech-stack" aria-label="Tecnologías principales">
          <div>
            <strong>Vue 3</strong>
      ...
      <div class="hero-visual" aria-hidden="true">
        <img
          :src="`${baseUrl}images/hero-techstore.webp`"
          alt=""
        />
        ...
        <div class="floating-card floating-top">
          <AppIcon name="lightning" size="18" />
          <span>Rápido y responsive</span>
        </div>
...
.hero-panel {
  ...
  border-radius: 34px;
  border: 1px solid rgba(75, 143, 240, 0.3);
...
.hero-secondary :deep(.v-btn__content) {
  display: flex;
  gap: 9px;
  align-items: center;
  font-weight: 800;
...
.hero-glow {
  ...
  top: -130px;
  border-radius: 50%;
  background: rgba(76, 156, 255, 0.28);
  filter: blur(50px);
}
...
.floating-card {
  ...
  color: #edf7ff;
  border: 1px solid rgba(116, 164, 220, 0.26);
